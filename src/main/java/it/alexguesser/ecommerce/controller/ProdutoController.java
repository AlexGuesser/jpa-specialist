package it.alexguesser.ecommerce.controller;

import it.alexguesser.ecommerce.model.Produto;
import it.alexguesser.ecommerce.repository.Produtos;
import it.alexguesser.ecommerce.service.ProdutoService;
...
public class ProdutoController {
    ...
    public ModelAndView atualizar(@PathVariable Integer id,
                                  ...
                                  @RequestAttribute String tenant) {
    ...
    public ModelAndView editar(@RequestAttribute String tenant, @PathVariable Integer id, ServletRequest servletRequest) {
